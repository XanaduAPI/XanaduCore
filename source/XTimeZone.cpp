...
int64S XTimeZone::toMillisecond() const noexcept
{
	return this->toSecond() * 1000;
}

int64S XTimeZone::toSecond() const noexcept
{
...
int64S XTimeZone::toMillisecond(ENUM_TIME_ZONE _TimeZone) noexcept
{
	return XTimeZone(_TimeZone).toMillisecond();
}

int64S XTimeZone::toSecond(ENUM_TIME_ZONE _TimeZone) noexcept
{
