#ifndef			_XANADU_CORE_TIMEZONE_H_
#define			_XANADU_CORE_TIMEZONE_H_

#include <XanaduCore/XHeader.h>
#include <XanaduCore/XTime.h>

// 时区
class XANADU_CORE_EXPORT XTimeZone
{
public:
...
public:
	virtual int64S toMillisecond() const noexcept;

	virtual int64S toSecond() const noexcept;

public:
	static int64S toMillisecond(ENUM_TIME_ZONE _TimeZone) noexcept;

	static int64S toSecond(ENUM_TIME_ZONE _TimeZone) noexcept;
};

#endif // _XANADU_CORE_TIMEZONE_H_
